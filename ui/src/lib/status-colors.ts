...
export const issueStatusIcon: Record<string, string> = {
  ...
  review_pending: "text-violet-600 border-violet-600 dark:text-violet-400 dark:border-violet-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  review_pending: "text-violet-600 dark:text-violet-400",
...
export const statusBadge: Record<string, string> = {
  ...
  review_pending: "bg-violet-100 text-violet-700 dark:bg-violet-900/50 dark:text-violet-300",
