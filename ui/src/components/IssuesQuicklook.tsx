...
import { formatIssueDisplayStatus, getIssueDisplayStatus } from "@paperclipai/shared/issue-display-status";
      ...
      >
        <div className="space-y-2">
          <div className="flex items-start gap-2">
            <StatusIcon status={displayStatus} className="mt-0.5 shrink-0" />
            <Link
          ...
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <span>·</span>
            <span>{formatIssueDisplayStatus(displayStatus)}</span>
            <span>·</span>
