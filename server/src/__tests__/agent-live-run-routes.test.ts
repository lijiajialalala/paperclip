...
function registerModuleMocks() {
  ...
  vi.doMock("../services/qa-issue-state.js", () => ({
    qaIssueStateService: () => ({
      getRunIssueWriteback: vi.fn(),
    }),
  }));

  vi.doMock("../services/platform-unblock.js", () => ({
...
describe("agent live run routes", () => {
  beforeEach(() => {
    ...
    vi.doUnmock("../services/qa-issue-state.js");
    vi.doUnmock("../services/platform-unblock.js");
