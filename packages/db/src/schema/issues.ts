...
export const issues = pgTable(
  "issues",
  {
    ...
    taskRootIssueId: uuid("task_root_issue_id").references((): AnyPgColumn => issues.id),
    ...
    planProposedAt: timestamp("plan_proposed_at", { withTimezone: true }),
  ...
  (table) => ({
    ...
    taskRootIdx: index("issues_company_task_root_idx").on(table.companyId, table.taskRootIssueId),
